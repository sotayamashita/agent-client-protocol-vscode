...
/** @internal */
export const extMethodRequestSchema = z.record(z.string(), z.unknown());
...
/** @internal */
export const extMethodResponseSchema = z.record(z.string(), z.unknown());
...
/** @internal */
export const extNotificationSchema = z.record(z.string(), z.unknown());
...
/** @internal */
export const extMethodRequest1Schema = z.record(z.string(), z.unknown());
...
/** @internal */
export const extMethodResponse1Schema = z.record(z.string(), z.unknown());

/** @internal */
export const sessionModeIdSchema = z.string();

/** @internal */
export const extNotification1Schema = z.record(z.string(), z.unknown());
